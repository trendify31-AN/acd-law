const translations = {
    ...
    fr: {
        ...
        "service5-description": "Notre cabinet d'avocats aux Émirats arabes unis propose des services juridiques fiscaux experts pour aider les entreprises à naviguer dans les complexités de l'enregistrement de la TVA, la conformité fiscale et la gestion financière. Nous offrons un soutien complet pour les opérations de base, la comptabilité, l'informatique et la gestion financière, garantissant que votre entreprise respecte toutes les exigences réglementaires. Notre équipe d'avocats fiscaux hautement qualifiés et expérimentés à Dubaï, Abu Dhabi et dans tout le pays se spécialise dans les questions fiscales nationales et transfrontalières, y compris la TVA, les déclarations de revenus et plus encore. Les clients font confiance à notre expertise pour gérer des questions fiscales complexes, de grande valeur et sensibles, garantissant les meilleurs résultats pour leur entreprise. Que vous soyez confronté à des questions fiscales de routine ou à des défis juridiques complexes, nos consultants juridiques sont prêts à fournir des conseils sur mesure et axés sur les résultats.",
    ...
    ar: {
        ...
        "service5-description": "ينظم قانون الضرائب العمليات المالية والتجارية والشخصية التي تتعلق بالضرائب. يشمل هذا القانون الالتزامات الضريبية والإجراءات الضريبية والتخفيف الضريبي، مع توجيه الأفراد والشركات للامتثال للقوانين الضريبية الوطنية والدولية.",
        ...
        "service5-content": "في Acker Choquette Dray Legal Consultants، نحن نقدم خدمات استشارية شاملة في قانون الضرائب للأفراد والشركات. نحن نقدم مساعدة في التخطيط الضريبي والامتثال الضريبي والتقديرات الضريبية والاسترداد الضريبي والتحقيق الضريبي والتخفيف الضريبي. يقدم فريقنا الخبرة والمعرفة اللازمة لمساعدتك في فهم القوانين الضريبية وتطبيقها بكفاءة، مع توجيهك خلال الإجراءات الضريبية وتقديم الحلول المخصصة لتحقيق الامتثال وتحقيق الأهداف المالية.",
